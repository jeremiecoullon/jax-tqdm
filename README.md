...
showing the individual progress of each process. To do this, wrap the loop
or scan in a function that takes the index of the progress bar and map that
...
def run_scan(bar_id):
    ...
    return lax.scan(step, 0, jnp.arange(n))
